...
public class TaskController {
    ...
    @Operation(
            ...
            description = """
                    Свои задачи можно получить указав параметр userId как 0. Задачи другого пользователя может получить любой аутентифицированный пользователь. Полученные задачи можно фильтровать по 2-м критериям, либо же не использовать фильтр
